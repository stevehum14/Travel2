  ...
  <div>
    ...
    <ul>
      ...
      <li class="item border-bottom">
        <img src="http://img1.qunarzz.com/sight/p0/1501/f4/f467729126949c3a.water.jpg_140x140_ef235b1c.jpg" alt="" class="item-img">
        <div class="item-info">
          <p class="item-title">南山滑雪场</p>
          <p class="item-desc">我爱北京天安门，天安门上太阳升</p>
          <button class="item-button">查看更多</button>
        </div>
      </li>
    </ul>
